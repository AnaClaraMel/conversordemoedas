...
public class ConexaoApi {
    ...
    public String ConsumoApi() {
        String apikEY = "9e433129837067d874863b9f";
        ...
        String mensagemUsuario = STR."""
        Resposta: \{amount} \{conversor.moedaEscolhida()} equivalem a \{conversor.valorCotacao()} \{conversor.moedaAConverter()}""";
